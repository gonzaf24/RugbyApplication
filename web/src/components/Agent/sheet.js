            ...
            <CardActionArea className={classes.bottom}>
              ...
              <CardContent>
                <Avatar
                  ...
                  alt={agent.nombre}
                  src={agent.fotoPerfil}
                />
                {user.uid !== agent.uid && (
                  <div className={classes.alignChat}>
                    <ChatDirect
                      uidSender={user.uid}
                      uidReceiver={agent.uid}
                      emailSender={user.email}
                      emailReceiver={agent.userEmail}
                      avatar={agent.fotoPerfil}
                      nombre={agent.nombre}
                    />
                  </div>
                )}
                    ...
                    >
                      <TableBody className={classes.tableBody}>
                        <TableRow key={t("txt.agencyName")}>
                          ...
                          <TableCell align="left">{agent.agencia}</TableCell>
                        </TableRow>
                        ...
                        <TableRow key={t("txt.phone")}>
                          ...
                          <TableCell align="left">{agent.telefono}</TableCell>
                        </TableRow>
                            ...
                            <TableRow key={row.uid}>
                              ...
                              <TableCell className={classes.tableFontSize}>
                                <LaunchIcon
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `/playerSheet/${row.uid}/${row.agentUID}`
                                    )
                                  }
                                />
                              </TableCell>
